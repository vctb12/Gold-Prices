...
> This file is the persistent task tracker for AI agents and human contributors.
> Agents: read this before starting any task. Update it after completing work.
> Last updated: <!-- agent: update this on every change -->
